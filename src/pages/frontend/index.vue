<template>
  <!--表头-->
    ...
    <!--文章主要部分-->
    <div class="container mx-auto max-w-screen-xl mt-5 bg-yellow-50">
        ...
        <div class="grid grid-cols-4 ">
            ...
            <div class="col-span-4 px-3 md:col-span-3 sm:col-span-4 ">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div v-for="(article, index) in articles" :key="index"
                        class="bg-gray-50 border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <!--作者及缩率图-->
                        ...
                        <div class="p-5">
                            ...
                            <div @click="goTagArticleListPage(item.id, item.name)" v-for="(item, index) in article.tags"
                                :key="index"
                                class="mb-3 inline-block bg-green-100 text-green-800 text-xs font-medium
                                mr-2 px-2.5 py-0.5 rounded hover:bg-green-200 hover:text-green-900
                                dark:hover:bg-green-800 dark:hover:text-green-300 dark:bg-green-900
                                dark:text-green-300">
                                {{ item.name }}
                            </div>
                    ...
                    <ul class="flex items-center justify-center mt-10 mb-10 -space-x-px h-10 text-base">
                        <li>
                            ...
                            <a v-else @click="getArticles(current)"
                                class="cursor-not-allowed flex items-center justify-center px-4 h-10 ml-0
                                leading-tight text-gray-500 bg-white border border-gray-300 rounded-l-lg
                        ...
                        <li v-for="page in pages" :key="page">
                            <a @click="getArticles(page)"
                                class="flex items-center border-gray-300 justify-center px-4 h-10 leading-tight bg-white border
                                dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                                :class="[page == current ? 'text-blue-600 bg-blue-50 hover:bg-blue-100 ' +
                                 'hover:text-blue-700' : 'text-gray-500  hover:bg-gray-100 hover:text-gray-700']">
                                {{ page }}
                            </a>
                        </li>
                        <li>
                            ...
                            <a v-else="current == pages" @click="getArticles(current)"
                                class="cursor-not-allowed flex items-center justify-center px-4 h-10 leading-tight text-gray-500
            ...
            <div class="col-span-4 px-3 md:col-span-1 sm:col-span-4">
                <div class="sticky top-21">
                    ...
                    <!-- 文章分类 -->
                    <div class="mb-3 w-full font-medium p-5 bg-blue-50 border border-gray-200
                        rounded-lg dark:bg-gray-800 dark:border-gray-700">

                        <h2 class="mb-2 font-bold text-gray-900 uppercase dark:text-white">分类</h2>

                        <div  class="text-sm font-medium text-gray-900 bg-blue-50 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">

                            <a @click="goCatagoryArticleListPage(item.id, item.name)" v-for="(item, index) in categories"
                                :key="index"
                                class="flex items-end block w-full px-4 py-2 rounded-lg cursor-pointer
                                ...
                                <svg class="w-4 h-4 mr-2 mb-2px text-gray-800 inline dark:text-white" aria-hidden="true"
                                    ...
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="0.9"
                                        d="M2.539 17h12.476l4-9H5m-2.461 9a1 1 0 0 1-.914-1.406L5 8m-2.461 9H2a1 1 0
                                         0 1-1-1V2a1 1 0 0 1 1-1h5.443a1 1 0 0 1 .8.4l2.7 3.6H16a1 1 0 0 1 1 1v2H5" />
                                </svg>
                                {{ item.name }}
                            </a>
                        </div>
                    ...
                    <!-- 文章标签 -->
                    <div
                        class="mb-3 w-full font-medium p-5 bg-blue-50 border border-gray-200
                        rounded-lg dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div @click="goTagArticleListPage(item.id, item.name)" v-for="(item, index) in tags" :key="index"
                            class="inline-block bg-green-100 text-green-800 text-xs font-medium
                            mr-2 mb-1 px-2.5 py-0.5 rounded hover:bg-green-200 hover:text-green-900
                            dark:hover:bg-green-800 dark:hover:text-green-300 dark:bg-green-900 dark:text-green-300">
                            {{ item.name }}
                        </div>
                    </div>
                </div>
